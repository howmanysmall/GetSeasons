--!optimize 2
--!strict
local function GetSummer(Year: number, YearFloat: number)
	local YearFloatSquared = YearFloat*YearFloat
	local YearFloatCubed = YearFloatSquared*YearFloat

	local Jd0 = 2451716.56767
		+ 365241.62603*YearFloat
		+ 0.00325*YearFloatSquared
		+ 0.00888*YearFloatCubed
		- 0.0003*YearFloatCubed*YearFloat
