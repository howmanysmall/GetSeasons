--!optimize 2
--!strict
local function GetAutumn(Year: number, YearFloat: number)
	local YearFloatSquared = YearFloat*YearFloat
	local YearFloatCubed = YearFloatSquared*YearFloat

	local Jd0 = 2451810.21715
		+ 365242.01767*YearFloat
		- 0.11575*YearFloatSquared
		+ 0.00337*YearFloatCubed
		+ 0.00078*YearFloatCubed*YearFloat
