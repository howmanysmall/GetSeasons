--!optimize 2
--!strict
local function GetSpring(Year: number, YearFloat: number)
	local YearFloatSquared = YearFloat*YearFloat
	local YearFloatCubed = YearFloatSquared*YearFloat

	local Jd0 = 2451623.80984
		+ 365242.37404*YearFloat
		+ 0.05169*YearFloatSquared
		- 0.00411*YearFloatCubed
		- 0.00057*YearFloatCubed*YearFloat
